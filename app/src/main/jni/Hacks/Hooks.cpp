...
// ================================================================
//  VARS NAMESPACE - Tất cả biến dùng trong Hooks.cpp
// ================================================================
namespace Vars {
...
// ================================================================
//  HOOKS NAMESPACE - Declarations khớp với Hooks.cpp
// ================================================================
namespace Hooks {

    // ── Old hook từ R3DNETWORK gốc (giữ để link không lỗi) ──
    ...
    void hook_ApplyDamage       (void* inst, long dmg, void* from,
